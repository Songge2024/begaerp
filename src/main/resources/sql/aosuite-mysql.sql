...
CREATE TABLE `aos_cmp` (
  ...
  `dom_id` varchar(255) NOT NULL COMMENT '界面组件ID',
  `page_key` varchar(255) NOT NULL COMMENT '所属页面标识',
  `page_name` varchar(255) NOT NULL COMMENT '所属页面名称',
  PRIMARY KEY (`id`),
  UNIQUE KEY `ukey1` (`dom_id`,`page_key`) USING BTREE
...
INSERT INTO `aos_icon` VALUES ('one_daily.png', '1');
INSERT INTO `aos_icon` VALUES ('two_daily.png', '1');
INSERT INTO `aos_icon` VALUES ('three_daily.png', '1');
INSERT INTO `aos_icon` VALUES ('four_daily.png', '1');
INSERT INTO `aos_icon` VALUES ('five_daily.png', '1');
INSERT INTO `aos_icon` VALUES ('six_daily.png', '1');
INSERT INTO `aos_icon` VALUES ('seven_daily.png', '1');
...
-- ----------------------------
INSERT INTO `aos_module` VALUES ('-1', '0.001.008.003', '45', '角色管理', 'roleService.init', 'own.png', '1', '0', '1', '', '30');
INSERT INTO `aos_module` VALUES ('37', '0', '0', 'AOS开发套件', '', 'home.png', '0', '1', '1', '', '1');
INSERT INTO `aos_module` VALUES ('38', '0.001', '37', '系统管理', '', 'folder22.png', '0', '1', '1', 'fa-cogs', '10');
INSERT INTO `aos_module` VALUES ('39', '0.002', '37', '范例', '', 'folder9.png', '0', '1', '1', 'fa-bug', '20');
INSERT INTO `aos_module` VALUES ('40', '0.002.001', '39', '综合实例', '', '', '0', '1', '1', '', '90');
INSERT INTO `aos_module` VALUES ('41', '0.001.007', '38', '资源', '', 'folder1.png', '0', '1', '1', '', '10');
INSERT INTO `aos_module` VALUES ('42', '0.001.007.001', '41', '键值参数', 'masterDataService.initParam', 'icon153.png', '1', '0', '1', '', '10');
INSERT INTO `aos_module` VALUES ('43', '0.001.007.002', '41', '数据字典', 'masterDataService.initDictionary', 'icon152.png', '1', '0', '1', '', '20');
INSERT INTO `aos_module` VALUES ('44', '0.001.007.003', '41', '功能模块', 'moduleService.init', 'icon154.png', '1', '0', '1', '', '30');
INSERT INTO `aos_module` VALUES ('45', '0.001.008', '38', '权限', '', 'folder1.png', '0', '1', '1', '', '20');
INSERT INTO `aos_module` VALUES ('46', '0.001.008.001', '45', '部门管理', 'orgService.init', 'org.png', '1', '0', '1', '', '10');
INSERT INTO `aos_module` VALUES ('47', '0.001.008.002', '45', '用户管理', 'userService.init', 'user6.png', '1', '0', '1', '', '20');
INSERT INTO `aos_module` VALUES ('49', '0.001.009', '38', '监控', '', 'folder1.png', '0', '1', '1', '', '30');
...
INSERT INTO `aos_module` VALUES ('61', '0.002.003', '39', '扩展组件', '', '', '0', '1', '1', '', '20');
INSERT INTO `aos_module` VALUES ('62', '0.002.003.001', '61', '文件上传', '', '', '1', '0', '1', '', '10');
INSERT INTO `aos_module` VALUES ('63', '0.002.002.002', '59', '容器组件及常用布局', 'demoService.initBasic2', '', '1', '0', '1', '', '20');
INSERT INTO `aos_module` VALUES ('64', '0.002.002.003', '59', '树组件', 'demoService.initTree', '', '1', '0', '1', '', '50');
INSERT INTO `aos_module` VALUES ('65', '0.002.002.004', '59', '表单组件', 'demoService.initForm', '', '1', '0', '1', '', '30');
INSERT INTO `aos_module` VALUES ('66', '0.002.002.005', '59', '表格组件', 'demoService.initGrid', '', '1', '0', '1', '', '40');
INSERT INTO `aos_module` VALUES ('67', '0.002.004', '39', '测试', '', '', '0', '1', '1', '', '99');
INSERT INTO `aos_module` VALUES ('68', '0.002.004.001', '67', '测试1', 'demoService.initTest1', '', '1', '0', '1', '', '10');
...
-- Records of aos_org
-- ----------------------------
INSERT INTO `aos_org` VALUES ('-1', '0', '中国工商银行', '', '0', '0', '1', 'home.png', '1', '', '1', '', '0', '2016-08-12 17:38:32', '-1');
INSERT INTO `aos_org` VALUES ('73', '0.001', '上海分行', '', '-1', '0', '1', '', '1', '', '1', '', '0', '2016-09-06 10:31:11', '-1');
INSERT INTO `aos_org` VALUES ('74', '0.001.001', '杨浦支行', '', '73', '1', '0', '', '1', '', '1', null, '0', '2016-09-06 10:33:05', '-1');
INSERT INTO `aos_org` VALUES ('75', '0.002', '广东分行', '', '-1', '1', '0', '', '1', '', '2', '', '0', '2016-09-06 23:48:52', '-1');
INSERT INTO `aos_org` VALUES ('76', '0.003', '云南分行', '', '-1', '1', '0', '', '1', '', '3', '', '0', '2016-09-06 23:49:14', '-1');
INSERT INTO `aos_org` VALUES ('251', '0.001.002', '测试', null, '73', '1', '0', null, '1', null, '2', null, '1', '2017-03-25 09:01:42', '-1');
...
-- ----------------------------
INSERT INTO `aos_params` VALUES ('77', '开发用户快捷登录开关', 'login_dev', '1', '1', '可选值：1 | 0。1：打开；0：关闭。');
INSERT INTO `aos_params` VALUES ('78', '系统缺省皮肤', 'skin', 'blue', '1', '可选值：blue|gray|aos。优先级低于用户自己的皮肤配置。');
INSERT INTO `aos_params` VALUES ('79', '登录页面的背景图片', 'login_back_img', '-1', '1', '登录页面的背景图片。可选的预设背景图片为：0.jpg、1.jpg、2.jpg。如果需要随机出现背景，则将其设置为-1。');
INSERT INTO `aos_params` VALUES ('80', '是否显示验证码', 'is_show_vercode', '1', '1', '是否在登录页面显示验证码及后台验证码验证。可选值：0(否) | 1(是)。');
INSERT INTO `aos_params` VALUES ('81', '验证码长度', 'vercode_length', '4', '1', null);
INSERT INTO `aos_params` VALUES ('82', '验证码待选字符集', 'vercode_characters', 'abcdetx2345678', '1', null);
INSERT INTO `aos_params` VALUES ('83', 'Tab高亮颜色', 'tab_focus_color', '#0099FF', '1', '缺省的当前Tab卡片高亮提示颜色');
INSERT INTO `aos_params` VALUES ('84', '表格分页行数', 'page_size', '50', '1', '缺省的分页大小。JSP页面的属性设置会覆盖这个配置。');
INSERT INTO `aos_params` VALUES ('85', '表格列单元格内容对齐方式', 'grid_column_algin', 'left', '1', '表格列对齐模式。有效值：left|center|right。');
INSERT INTO `aos_params` VALUES ('86', '全局右键', 'prevent_rightclick', 'false', '1', '阻止浏览器缺省鼠标右键事件。可选值：true|false。缺省值：true。');
INSERT INTO `aos_params` VALUES ('87', '下拉选择框的缺省提示信息', 'combobox_emptytext', '请选择...', '1', null);
INSERT INTO `aos_params` VALUES ('88', '表单校验消息提示方式', 'msgtarget', 'qtip', '1', '可选值必须是下列值之一 (1)、qtip 当用户鼠标悬停在该域之上时显示包含了消息的迅速提示。(2)、title 显示消息以浏览器默认的title属性弹出。 (3)、under 在域下方添加一块包含了错误消息的div。(4)、side 添加一个错误图标在域的右边，鼠标悬停上面时弹出显示消息。');
INSERT INTO `aos_params` VALUES ('89', '水平导航条按钮风格', 'nav_button_style', 'tight', '1', '顶部水平导航条的按钮样式风格。tight：组合按钮；standalone：独立按钮。');
INSERT INTO `aos_params` VALUES ('90', '是否显示水平导航条', 'is_show_top_nav', '1', '1', '是否显示水平导航条。可选值：1 | 0。');
INSERT INTO `aos_params` VALUES ('91', '页面刷新动画文件', 'page_load_gif', 'wheel.gif', '1', '页面刷新动画文件。可选的预设动画文件：run.gif、wheel.gif。动画path：/static/image/gif/pageload。');
INSERT INTO `aos_params` VALUES ('92', '运行模式', 'run_mode', '0', '1', '0：开发模式；1：生产模式；2：在线体验模式');
INSERT INTO `aos_params` VALUES ('93', '功能模块页面加载等待提示信息', 'page_load_msg', '正在拼命带你飞, 请稍候...', '1', '');
INSERT INTO `aos_params` VALUES ('94', '欢迎页标题', 'welcome_page_title', '欢迎', '1', '');
INSERT INTO `aos_params` VALUES ('95', '版权信息', 'copyright', '2008-2016 AOSuite', '1', '');
INSERT INTO `aos_params` VALUES ('96', '用户会话Redis超时时间', 'user_login_timeout', '18000', '1', '以秒(s)为单位。18000=5小时。');
INSERT INTO `aos_params` VALUES ('97', '首页浏览器标题', 'app_title', '项目管理平台', '1', '');
INSERT INTO `aos_params` VALUES ('98', '加解密算法密钥', 'code_key', 'HY&XC&MW', '1', '用户密码加解密算法密钥：密钥不能小于8位');
INSERT INTO `aos_params` VALUES ('99', 'QQ群推广链接', 'qq_group_link', 'http://jq.qq.com/?_wv=1027&k=40fPema', '1', '当系统处于在线演示模式时，登录系统后会弹出自动加QQ群提示。');
INSERT INTO `aos_params` VALUES ('100', '表格查询无数据时的显示信息', 'grid_empty_text', '没有查询到符合条件的数据 : ( ', '1', '');
INSERT INTO `aos_params` VALUES ('101', '登录请求等待信息', 'login_wait_msg', '正在拼命带你飞, 请稍候...', '1', '');
INSERT INTO `aos_params` VALUES ('102', '开发用户快捷登录账户', 'login_dev_account', 'root', '1', '可设置为任意一个系统存在的账户。');
...
-- Records of aos_role
-- ----------------------------
INSERT INTO `aos_role` VALUES ('-1', '超级用户角色', '1', '1', null, null, '2016-08-14 14:18:28', '-1');
INSERT INTO `aos_role` VALUES ('296', '测试角色', '1', '1', '', '', '2017-03-26 23:42:34', '-1');
...
-- ----------------------------
INSERT INTO `aos_role_module` VALUES ('297', '296', '37', '1', '2017-03-26 23:43:37', '-1');
INSERT INTO `aos_role_module` VALUES ('298', '296', '38', '1', '2017-03-26 23:43:37', '-1');
INSERT INTO `aos_role_module` VALUES ('299', '296', '41', '1', '2017-03-26 23:43:37', '-1');
...
CREATE TABLE `aos_sequence` (
  ...
  `increment` int(4) NOT NULL DEFAULT '1' COMMENT '增长步长',
  PRIMARY KEY (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='序列生成器表';
...
-- Records of aos_user
-- ----------------------------
INSERT INTO `aos_user` VALUES ('-1', 'root', 'a2c292420f2af5038fefd1bb63eeb736', '超级用户', '1', '1', '1', '-1', '', '', '', 'blue', '', '', '', '0', '2016-08-12 17:38:19', '-1');
INSERT INTO `aos_user` VALUES ('353', 'lilei', 'a2c292420f2af5038fefd1bb63eeb736', '李雷', '3', '1', '1', '74', null, null, null, 'blue', null, null, null, '0', '2017-03-27 18:20:28', '-1');
...
-- ----------------------------
INSERT INTO `aos_user_role` VALUES ('295', '-1', '-1', '2017-03-26 23:41:49', '-1');
INSERT INTO `aos_user_role` VALUES ('356', '353', '296', '2017-03-28 18:30:00', '-1');
