...
<%@ include file="/WEB-INF/jsp/common/tags.jsp"%>
	<aos:hiddenfield name="code_version_id" fieldLabel="代码版本号主键ID" />
	<aos:textfield name="code_version_number" fieldLabel="代码版本号" allowBlank="false" maxLength="60"/>
	<aos:hiddenfield name="version_id" fieldLabel="项目版本号ID" allowBlank="false" />
	<aos:hiddenfield name="test_version_id" fieldLabel="测试版本号ID" allowBlank="false" />
	...
	<aos:hiddenfield name="state" fieldLabel="状态（1 有效 0 无效）" allowBlank="true" />
