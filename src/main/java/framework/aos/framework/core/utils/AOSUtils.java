...
public class AOSUtils {
	...
	public static int getIntervalDays(java.util.Date startDate, java.util.Date endDate) {
		...
		int intervalday = (int) Math.round((double)interval / (1000 * 60 * 60 * 24));
		return intervalday;
	}
	 ...
	 * @return int 返回间隔天数
	 */
	public static String getIntervalDay(java.util.Date startDate, java.util.Date endDate) {
		long startdate = startDate.getTime();
		long enddate = endDate.getTime();
		long interval = enddate - startdate;
		double in = (double)interval / (1000 * 60 * 60 * 24);
		String intervalday = String.format("%.1f", (double)interval / (1000 * 60 * 60 * 24));
		return intervalday;
	}
	 ...
	 * @return int 返回间隔天数
	 */
	public static String getIntervalDays(java.util.Date startDate, java.util.Date endDate,String fmt) {
		String format=isEmpty(fmt)?"#.00":fmt;
		long startdate = startDate.getTime();
		long enddate = endDate.getTime();
		long interval = enddate - startdate;
		float intervalday = (float) (interval / (1000 * 60 * 60 * 24));
		return new java.text.DecimalFormat(format).format(intervalday);
	}
	 ...
	 * @return
	 */
	public static String getRandomOrderStr(long length){
		String machineId="1";
