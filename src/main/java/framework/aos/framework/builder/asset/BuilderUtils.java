...
public class BuilderUtils {
    ...
    public static Dto convertTableVO(TableVO tableVO) {
        ...
        String className=AOSUtils.isNotEmpty(tableVO.getPrefix())? name.replace(tableVO.getPrefix(), ""):name;
		...
		while(StringUtils.indexOf(name, "_") > 0){
			...
			className=StringUtils.replace(className, "_" + charString, charString.toUpperCase());
		}
		tableDto.put("upclassname", StringUtils.capitalize(className));
		tableDto.put("lowclassname", className.substring(0, 1).toLowerCase() + className.substring(1));
