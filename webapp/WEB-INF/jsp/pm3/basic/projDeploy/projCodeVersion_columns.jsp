...
<%@ include file="/WEB-INF/jsp/common/tags.jsp"%>
	<aos:column header="代码版本号ID" dataIndex="code_version_id" width="100" hidden="true"/>
	<aos:column header="代码版本号" dataIndex="code_version_number" width="140" />
	<aos:column header="状态" dataIndex="state" width="55" rendererFn="fn2_state_render"/>
	...
	<aos:column header="修改人ID" dataIndex="update_id" width="100" hidden="true"/>
	<aos:column header="修改人" dataIndex="update_name" width="53" />
	<aos:column header="修改时间" dataIndex="update_time" width="100" />
	

	<script type="text/javascript">
		function fn2_state_render(value, metaData, record){
			if(value == 0){
