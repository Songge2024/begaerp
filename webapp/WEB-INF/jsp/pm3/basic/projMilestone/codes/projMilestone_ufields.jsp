...
<aos:datefield id="be_date" name="plan_begin_date" fieldLabel="计划开始时间" labelWidth="120" 
	allowBlank="false" onselect="on_plan_wastage_begin_change"
	 columnWidth=".5" />
<aos:datefield id="en_date" name="plan_end_date" fieldLabel="计划结束时间" labelWidth="120"
	allowBlank="false" onselect="on_plan_wastage_end_change"
 columnWidth=".5" />
	<aos:numberfield  name="plan_jobamount" fieldLabel="计划工作量(人天)"    allowBlank="false"   columnWidth=".5" labelWidth="120"  minValue="0"/>
	<aos:numberfield id="id_uplan" name="plan_wastage" fieldLabel="计划天数"  labelWidth="120"
...
<aos:datefield  name="real_begin_date"  fieldLabel="实际开始时间"   hidden="true"  columnWidth=".5" labelWidth="120" />
	<aos:datefield  name="real_end_date"    fieldLabel="实际结束时间"   hidden="true"  columnWidth=".5" labelWidth="120"/>
	 	<aos:numberfield  name="real_jobamount" fieldLabel="实际工作量(人天)"  hidden="true"   columnWidth=".5" labelWidth="120" minValue="0"/>
	 	 <aos:numberfield  name="earned_value" fieldLabel="挣值(ev)"  hidden="true" readOnly="true" labelWidth="120" columnWidth=".5" emptyText="计划工作量/实际工作量"/>
