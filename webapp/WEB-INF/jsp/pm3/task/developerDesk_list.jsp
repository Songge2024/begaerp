...
<aos:html title="开发者工作台（临时）" base="http" lib="ext">
...
<aos:onready>
	<aos:viewport layout="anchor" >
			...
			<aos:gridpanel title="我的缺陷" border="true" flex="1" autoScroll="true"
					...
					url="developerDeskService.page4" onrender="book_grid_query4">
					<aos:selmodel type="checkbox" mode="multi" />
					...
					<aos:column header="提交人" dataIndex="create_man" fixedWidth="80"
						align="center" />
