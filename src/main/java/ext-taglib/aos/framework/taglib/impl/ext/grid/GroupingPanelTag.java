 ...
 * @date 2014-05-02
 */
public class GroupingPanelTag extends PanelTagSupport {
	...
	public int doEndTag() throws JspException {
		...
		//扩展分组标签
		tagDto.put("groupField", getGroupField());
		tagDto.put("property", getProperty());
		tagDto.put("groupHeaderTpl", getGroupHeaderTpl());
		tagDto.put("startCollapsed", getStartCollapsed());
		...
		String jspString = mergeFileTemplate(EXTVM + "grid/groupingPanelTag.vm", tagDto);
		try {
	...
	public String getStartCollapsed() {
		return startCollapsed;
	}

	public void setStartCollapsed(String startCollapsed) {
